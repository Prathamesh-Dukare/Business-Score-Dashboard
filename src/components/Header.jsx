        ...
        <section className='header'>
            ...
            <div className='header-nav flex justify-between items-center'>
                <div className="navigate flex items-center space-x-3">
                    <img className="back-arrow w-3" src={arrowImg} alt="Back" />
                    <p className='text-lg hidden s-mobile:block'>Search Results</p>
                </div>

                <div className="company flex items-center space-x-3">
                    <p>TATA Capital Limited</p>
                    <img className='rounded-full w-12' src={tataLogo} alt="Tata logo" />
                </div>
            </div>

            <div className="search flex bg-bg-light p-3 space-x-3 my-2 rounded-md">
